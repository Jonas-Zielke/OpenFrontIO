...
export const buildTable: BuildItemDisplay[][] = [
  [
    ...
    {
      unitType: UnitType.NuclearSubmarine,
      icon: warshipIcon,
      description: "build_menu.desc.nuclear_submarine",
      key: "unit_type.nuclear_submarine",
      countable: true,
    },
    {
    ...
    {
      unitType: UnitType.MultiFighter,
      icon: warshipIcon,
      description: "build_menu.desc.multi_fighter",
      key: "unit_type.multi_fighter",
      countable: true,
    },
    {
    ...
    {
      unitType: UnitType.LongRangeSAMLauncher,
      icon: samlauncherIcon,
      description: "build_menu.desc.long_range_sam_launcher",
      key: "unit_type.long_range_sam_launcher",
      countable: true,
    },
    {
    ...
    {
      unitType: UnitType.MilitaryAirport,
      icon: samlauncherIcon,
      description: "build_menu.desc.military_airport",
      key: "unit_type.military_airport",
      countable: true,
    },
  ],
];
